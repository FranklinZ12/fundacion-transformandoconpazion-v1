...
const navItems = [
  ...
  { href: "/admin/club-deportivo", icon: "fa-futbol", label: "Club deportivo", permission: "manage:sports", roles: ["administrador", "consultor"] },
...
export default function AdminSidebar({ profile }) {
    ...
    return (
      <>
        <div className="px-6 py-5 border-b border-gray-100 flex items-center justify-between">
          ...
          <button
            onClick={closeMobile}
            className="md:hidden w-8 h-8 flex items-center justify-center rounded-lg text-gray-400 hover:bg-gray-100 hover:text-gray-600 transition-colors"
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`w-64 shrink-0 bg-white border-r border-gray-100 flex flex-col min-h-screen fixed md:static inset-y-0 left-0 z-50 transition-transform duration-300 ${
      ...
      <button
        ...
        className="md:hidden fixed top-4 left-4 z-30 w-10 h-10 flex items-center justify-center rounded-xl bg-white border border-gray-100 shadow-sm text-gray-600 hover:text-[#872075] transition-colors"
