...
const volunteerRoles = [
  {
    ...
    badge: "Deporte",
    title: "Líder Deportivo",
    desc: "Buscamos jóvenes apasionados por el deporte que quieran apoyar nuestros entrenamientos, torneos y actividades físicas en la comunidad.",
  },
  {
    ...
    desc: "Formamos líderes con visión empresarial para generar ingresos, empleo e innovación social en el territorio de la comuna 15.",
  },
  {
    ...
    desc: "Jóvenes con ganas de pertenecer a nuestra fundación, liderar proyectos y construir un mejor futuro para la comunidad.",
  },
];
...
const donationTiers = [
  {
    ...
    title: "Donación en Materiales",
    value: "Desde $10.000",
    desc: "Equipos, implementos deportivos y herramientas para continuar nuestros proyectos con los jóvenes.",
    color: "from-[#872075]/10 to-[#872075]/5",
    iconBg: "bg-[#872075]/10 text-[#872075]",
  },
  {
    icon: "fa-solid fa-hand-holding-dollar",
    title: "Donación Económica",
    value: "Desde $10.000",
    desc: "Cada peso aporta directamente al bienestar y desarrollo de nuestra población juvenil en Medellín.",
    color: "from-[#c3171c]/10 to-[#c3171c]/5",
    iconBg: "bg-[#c3171c]/10 text-[#c3171c]",
  },
  {
    icon: "fa-solid fa-gift",
    title: "Donación Libre",
    value: "A tu medida",
    desc: "Conocimiento, espacio, estructura u otro tipo de apoyo. Todo aporte suma a la transformación social.",
        ...
        <section aria-labelledby="voluntariado-heading">
          ...
          <div className="text-center mb-12">
            ...
            <h2 id="voluntariado-heading" className="text-3xl sm:text-4xl font-extrabold text-gray-900 tracking-tight">
              ¿Quieres ser parte <span className="text-[#872075]">del cambio?</span>
            </h2>
            <p className="mt-3 text-gray-500 max-w-xl mx-auto text-sm leading-relaxed">
              Buscamos jóvenes comprometidos con el desarrollo social de la comunidad. Aquí hay un lugar
              para ti sin importar cuál sea tu talento.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-12 items-start">
            ...
            <div>
              ...
              <h2 id="donaciones-heading" className="text-3xl sm:text-4xl font-extrabold text-gray-900 tracking-tight mb-3">
                Tu aporte <span className="text-[#c3171c]">transforma vidas</span>
              </h2>
              <p className="text-sm text-gray-500 leading-relaxed mb-8 max-w-md">
                Con tu donación financiamos proyectos deportivos, culturales y educativos que impactan
                directamente a los jóvenes de la comunidad.
              </p>

              <div className="space-y-4">
                {donationTiers.map((tier, i) => (
                  <div key={i} className={`flex items-start gap-4 rounded-2xl bg-gradient-to-r ${tier.color} p-5`}>
                    <div className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-xl ${tier.iconBg}`}>
            ...
            <div className="space-y-5">
              <div className="rounded-3xl bg-gradient-to-br from-[#872075] to-[#5a1050] p-8 text-white shadow-xl">
                <div className="mb-6">
                  ...
                  <h3 className="text-xl font-extrabold">Cada donación cuenta</h3>
                  <p className="text-sm text-purple-200 mt-1 leading-relaxed">
                    Mira lo que hemos construido juntos desde 2017 en la comuna 15.
                  </p>
                </div>
      ...
      <section className="bg-gradient-to-r from-[#872075] to-[#5a1050] py-16 px-4">
        <div className="max-w-3xl mx-auto text-center text-white">
          ...
          <p className="text-purple-200 text-sm leading-relaxed mb-8 max-w-xl mx-auto">
            Únete a nosotros como voluntario o apoya la causa con una donación. Juntos construimos
            un mejor futuro para los jóvenes de la comuna 15.
          </p>
